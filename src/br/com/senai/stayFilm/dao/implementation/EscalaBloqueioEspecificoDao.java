...
public class EscalaBloqueioEspecificoDao  implements GenericDao<EscalaBloqueioEspecifico> {
	...
	public void delete(Long id) throws SQLException {
		EscalaBloqueioEspecifico escalaBloqueioEspecifico = 
				manager.find(EscalaBloqueioEspecifico.class, id);
	...
	public List<EscalaBloqueioEspecifico> ListarEscalaBloqueioEspecifico(){
		TypedQuery<EscalaBloqueioEspecifico> query =
				manager.createQuery("SELECT e FROM EscalaBloqueioEspecifico e", EscalaBloqueioEspecifico.class);
