...
public class EscalaRestController {
	 ...
	 * @throws SQLException
	 */
	@RequestMapping(value = "/listarEscalaMontada/{idColaborador}", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
	...
	@RequestMapping(value = "/diasConcluidosMes", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_UTF8_VALUE)
